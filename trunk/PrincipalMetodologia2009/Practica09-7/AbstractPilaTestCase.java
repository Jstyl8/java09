...
public abstract class AbstractPilaTestCase extends TestCase {
    ...
    public final void testCima() {
        ...
        try {
            ...
            DesbordamientoInferiorException e = new DesbordamientoInferiorException("pila vacia");
    ...
    public final void testCimaYDesapilar() throws DesbordamientoInferiorException {
