package com.mp.practica5.ejercicio5.test;

import java.util.Arrays;
import java.util.Collections;
import java.util.Random;

import com.mp.practica5.ejercicio5.Baraja;
import com.mp.practica5.ejercicio5.Carta;
import com.mp.practica5.ejercicio5.NumeroPaloComparator;
...
public class BarajaTest extends TestCase {
	...
	public void testOrdenarBarajaSortNumeroPaloComparatorReverseOrder() {
		...
		for (int i = 0; i < cartas.length ; i++) {
			//System.out.println(i +"\t "+ (cartas.length - 1 - i)+"\t "+ cartas[i]+" <-> "+ cartasNP[cartas.length - 1 - i]);
