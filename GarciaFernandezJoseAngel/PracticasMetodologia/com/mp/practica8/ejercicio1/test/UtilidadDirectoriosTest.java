package com.mp.practica8.ejercicio1.test;
...
import com.mp.practica8.ejercicio1.UtilidadDirectorios;
...
public class UtilidadDirectoriosTest extends TestCase {
    ...
    public void testDirectoriosFicherosJava() throws IOException {
        ...
        for (Iterator iter = listado.iterator(); iter.hasNext();) {
            ...
            if (salida.contains(".java")& !salida.contains("Test")& !salida.contains(".svn")) {
    ...
    public void testZip() {
        ...
        String directorioZip = directorioEntrada + File.separator + "PracticasMetodologia" + File.separator;
