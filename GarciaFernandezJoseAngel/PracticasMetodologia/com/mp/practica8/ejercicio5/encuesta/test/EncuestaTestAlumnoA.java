...
public class EncuestaTestAlumnoA extends TestCase {
	...
	private void cargarPreguntas() {
		...
		contestacion = "GarciaFernandezJoseAngel";
		...
		contestacion = "Como esta , no esta mal, si la pareja se pone de acuerdo puede ser muy util, pero es dificil adaptarse";
		pc = new PreguntaContestacion(numero, tipo, pregunta, contestacion);
		encuesta.addPregunta(pc);
		...
		contestacion = "Sinceramente no lo se, quizas porque al tener bastante informacion por la red y demas prefieren hacer otra cosa";
		pc = new PreguntaContestacion(numero, tipo, pregunta, contestacion);
		encuesta.addPregunta(pc);
