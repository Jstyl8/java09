...
/**
 * Clase que implementa la interfaz Problema y se usa para la realizacion de
 * EsquemaDYV
 * 
 * @author Jose Angel Garcia Fernandez
 * @version 1.0 24/04/2009
 */
public class ProblemaMergeSort implements Problema  {
	 ...
	 */
	public ProblemaMergeSort(Comparable[] vector, int izq, int der) {
		this.vector = vector;
		this.izq = izq;
		this.der = der;
	}
