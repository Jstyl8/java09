...
import com.mio.estructurasdatos.Iterable;
import com.mio.estructurasdatos.ListaAbstracta;
 ...
 */
public class ArrayListaSimple extends ListaAbstracta implements Iterable,
		Serializable {
	 ...
	 *            a poner
	 */
	public ArrayListaSimple(int capacidadInicial) {
	 ...
	 *            a poner
	 */
	public ArrayListaSimple(Object[] array) {
		this.array = array;
		tamaño = 0;
	...
	public IteradorSimple iteradorSimple() {
		return new ArrayIteradorSimple(array, 0, tamaño);
	}
